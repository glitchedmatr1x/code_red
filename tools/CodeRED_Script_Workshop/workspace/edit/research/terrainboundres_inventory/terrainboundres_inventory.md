...
Archive: `D:\Games\Red Dead Redemption\game\terrainboundres.rpf`
...
- `root/terrainboundres/territory_swall_noid/19001d40_bnd.wtb` index=8 stored=8247 decoded=16384 decode=ok
- `root/terrainboundres/territory_swall_noid/12c02000_bnd.wtb` index=9 stored=39859 decoded=65536 decode=ok
- `root/terrainboundres/territory_swall_noid/16402780_bnd.wtb` index=10 stored=69262 decoded=102400 decode=ok
- `root/terrainboundres/territory_swall_noid/18402480_bnd.wtb` index=11 stored=9579 decoded=16384 decode=ok
- `root/terrainboundres/territory_swall_noid/0b8020c0_bnd.wtb` index=12 stored=42263 decoded=65536 decode=ok
- `root/terrainboundres/territory_swall_noid/10001e40_bnd.wtb` index=13 stored=5124 decoded=12288 decode=ok
- `root/terrainboundres/territory_swall_noid/12802080_bnd.wtb` index=14 stored=34112 decoded=57344 decode=ok
