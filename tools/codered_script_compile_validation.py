...
def write_build_plan(root: Path, report: ValidationReport) -> Path:
    ...
    lines = [
        ...
        "- Keep existing binary .wsc/.csc/.xsc/.sco roundtrip proof-gated until separately proven.",
        "",
        "Validated files:",
    ]
...
def validate(root: Path) -> ValidationReport:
    ...
    notes = [
        ...
        "It does not claim arbitrary existing .wsc/.csc/.xsc/.sco binary roundtrip is solved.",
