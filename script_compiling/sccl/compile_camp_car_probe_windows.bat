...
echo [CodeRED] Direct SC-CL camp car probe compile...
...
set "OUT=%OUT_ROOT%\camp_car_probe"
set "OUT_ARG=%OUT%\\"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Remove-Item -LiteralPath '%OUT_ROOT%\camp_car_probecamp_car_probe.xsc','%OUT_ROOT%\camp_car_probecamp_car_probe.sco','%OUT%\camp_car_probe.xsc','%OUT%\camp_car_probe.sco' -Force -ErrorAction SilentlyContinue"
