...
- Output folder: `D:\Games\Red Dead Redemption\Code_RED\build\mp_xenon_full_conversion_pass2\import_ready_wsc_from_xsc_named`

## Status Counts

- `pc_wsc_magicrdr_table_candidate_runtime_unproven`: `56`
...
- `ctf/ctf_base_game.xsc` -> `pc_wsc_magicrdr_table_candidate_runtime_unproven` size=`45643` error=``
- `deathmatch/deathmatch.xsc` -> `pc_wsc_magicrdr_table_candidate_runtime_unproven` size=`34739` error=``
- `freemode/freemode.xsc` -> `pc_wsc_magicrdr_table_candidate_runtime_unproven` size=`47932` error=``
- `mp_idle.xsc` -> `pc_wsc_magicrdr_table_candidate_runtime_unproven` size=`41670` error=``
...
- `support/mp_actorpicker.xsc` -> `pc_wsc_magicrdr_table_candidate_runtime_unproven` size=`20332` error=``
